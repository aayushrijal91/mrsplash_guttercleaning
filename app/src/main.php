    ...
    <div class="container">
        <div class="row justify-content-between gy-5">
            <div class="col-xl-6 col-xxl-5">
                <h1 class="fs-72 text-white fw-700 lh-1">Mr Splash Gutter Cleaning Sydney</h1>
                <div class="text-white fs-24 fw-400 py-4">Offering the best gutter cleaning service in Sydney</div>
                <div class="row pt-4">
                    <div class="col">
    ...
    <div class="container">
        <div class="row gy-4">
            <div class="col-6 col-lg-3">
                ...
                <div>Plumbing & Metal Gutter Cleaning</div>
            </div>
            <div class="col-6 col-lg-3">
                <?= renderImg('reroofing.png', 'lib') ?>
                <div>Regutter cleaning</div>
            </div>
            <div class="col-6 col-lg-3">
            ...
            <div class="col-6 col-lg-3">
                ...
                <div>Gutter Cleaning Repairs</div>
            </div>
        </div>
    </div>
</section>
...
<section class="about d-none d-md-block">
    <div class="container">
        <div class="row align-items-center gy-5">
            <div class="col-xl-6">
                <div class="fs-72 lh-1 fw-700 text-primary">Is it time for a gutter clean?</div>
                <div class="py-5 text-dark fs-36 fw-800 lh-1">
                    Yes! We are the right team for your gutter cleaning job!
                </div>
                <div class="fs-18 lh-1_67 text-grey">
                    <p class="pb-4">Welcome to Gutter Cleaning Services Sydney by Mr Splash, your Sydney wide Gutter Cleaning Service Company Sydney & General Plumbing Company Sydney. We pride ourselves on our eccentric workmanship and company process. We have been established since 2010 and have always been a company with pride and love for our clients.</p>
                    <p class="pb-4">Gutter Cleaning Services Sydney have been an in demand service offered by Mr Splash since 2010 with to date over 3600 Bathrooms Renovated. The growth of our service division has come via our unparalleled designs and workmanship. We are truly the right company to choose for your next Gutter Cleaning Service project. Gutter Cleaning services are a highly emotional project that requires a company that not only has the creative capabilities but also the experience to know the latest styles and trends that complete a finished gutter cleaning.</p>
                </div>
                <div class="row">
                    <div class="col-auto">
        ...
        <div class="row gx-0">
            ...
            <div class="col-lg-6">
                <div class="map-description">
                    <div class="fs-72 fw-700 lh-1 pb-3">Mr Splash Gutter Cleaning Services Sydney:</div>
                    <div class="fs-18 lh-1_67 text-secondary pt-4">We can renovate and expand on any gutter cleaning. Our team will walk you through the project and what your imagination of your new gutter cleaning will look like. Advice and guidance is the most valuable asset when it comes to going through any type of gutter cleaning service Sydney and we are a company that understands this. So if you’re in the market and looking for the best Bathroom Service company then let us demonstrate our process.</div>
                </div>
            </div>
        </div>
    </div>
    ...
    <div class="container-fluid">
        <div class="row justify-content-center">
            <div class="col-xxl-11">
                <div class="fs-72 fw-700 text-primary text-center lh-1 pb-5 d-none d-md-block">Mr Splash Gutter Services</div>
                <div class="row pt-2 gy-3 justify-content-center gx-3">
